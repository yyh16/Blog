...
initialize:function(container,data,b,options){
	...
	Attr(this.iframe,{frameborder:0,src:"about:blank",width:Sys.IE?this.option.width:this.option.width-4,height:Sys.IE?this.option.height-66:this.option.height-70});
...
var editer= new Editer($('ss'),data,LightBox.init());

editer.setValue('hello,world');

function postData(){

	var myForm = document.createElement("form");
	myForm.method = "post";
	myForm.action = "posthandler.php";
	
	var titleinput = document.createElement("input");
	titleinput.type = "text";
	titleinput.name="title";
	titleinput.value=eval(document.getElementById('edit_title')).value;
	myForm.appendChild(titleinput);
		
	var contentinput = document.createElement("input");
	contentinput.type = "text";
	contentinput.name="content";
	contentinput.value=editer.getValue();
...
editer.setValue('在此键入内容');
$('get').onclick = function(){
	postData();
	}
$('set').onclick = function(){editer.setValue('在此键入内容')}
}